-- =====================================================================
--  FUNKCJE RPC dla Neon Postgres (bez Supabase Auth)
--  W Neon dostęp do bazy ma tylko neondb_owner przez Vercel Functions,
--  więc nie potrzebujemy GRANT TO anon ani RLS.
-- =====================================================================

CREATE EXTENSION IF NOT EXISTS pgcrypto;


-- ----- 1. check_user_exists - lookup powracającego ucznia -----
...
-- ----- 2. get_station_questions - 3 losowe pytania -----
...
-- ----- 3. submit_station_result - lazy create user + zapis -----
